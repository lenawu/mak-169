...
Background: User and Project Included on the Database
	...
	Given PENDING it is currently Jan 1, 2016
...
Scenario: Signing in
	When PENDING I sign in with "email@berkeley.com" and "password"
...
Scenario: Signing out
	When PENDING I sign in with "email@berkeley.com" with "password"
